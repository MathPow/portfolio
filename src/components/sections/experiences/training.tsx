...
import ExperienceWindow from "@/components/sections/experiences/experienceWindow";
...
export default function Training({
  ...
  return (
    <>
      <div
        className="absolute z-20 top-[calc(2vw+70px)] left-[calc(10vw+10px)] flex flex-row blur-background-min rounded-full"
        onClick={togglePage}
      >
      ...
      {trainingNumber == 1 && (
        <ExperienceWindow
          title={"Étude collégiale au Cégep de Sainte-Foy"}
          subtitle={""}
          date={"En cours..."}
          page1Content={"Technique en informatique"}
          page2Content={""}
          webLink={
      ...
      {trainingNumber == 2 && (
        <ExperienceWindow
          ...
          subtitle={""}
          date={"2021"}
          page1Content={"L’École secondaire les Etchemins, Lévis"}
          page2Content={""}
          webLink={""}
          logo={null}
        />
      ...
      {trainingNumber == 3 && (
        <ExperienceWindow
          title={"Entrain d'aquérir des formations"}
          subtitle={""}
          date={""}
          page1Content={""}
          page2Content={""}

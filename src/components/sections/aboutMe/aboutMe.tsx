...
export default function AboutMe() {
  ...
  return (
    <section
      className={`flex flex-col justify-start absolute z-20 top-[calc(3vw+80px)] w-[calc(50vw+100px)] left-0 right-0 mx-auto gap-10 pointer-events-auto md:pointer-events-none pb-32`}
    >
      <div className="flex flex-col blur-background">
        <h3 className="text-3xl font-bold mb-4 text-white">
          Enchanté, je suis Mathys
        </h3>
        {/* <p>I am a {displayedText}</p> */}
        <p className="text-lg text-gray-300">
          Je suis un passionné par toutes les facettes de l&apos;informatique et
          de la gestion. J&apos;aime surtout innover dans le secteur du web et
          créer des expériences utilisateur fluides et fascinantes. Je me tiens
          à jour avec les nouvelles technologies et je n&apos;hésite pas à
      ...
      <div className="flex md:flex-row flex-col gap-12 w-[calc(50vw+100px)]">
        <div className="flex flex-col blur-background flex-1">
          ...
          <div className="grid grid-cols-2 gap-y-1">
            <p className="text-lg text-gray-300">
              JavaScript CSS HTML C++ C# Java MySQL Bash React Vue.js
              tailwindcss FireBase Git GitLab GitHub Canva Figma VSCode Dart
              Flutter DaisyUI Stencil.js Jira PHP Docker Unity
            </p>
          </div>
        </div>
